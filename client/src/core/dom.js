    ...
    export const DOM = {
      ...
      entry: {
        ...
        customBarcode: {
          preview: document.getElementById("custom-barcode-preview"),
          img: document.getElementById("custom-barcode-img"),
          text: document.getElementById("custom-barcode-text"),
          generateBtn: document.querySelector("#form-custom .scan-button"),
        },
      },
